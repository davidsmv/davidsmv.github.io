const bookData = [
    {
        goodreadsHtml: `<a href="https://www.goodreads.com/book/show/210408850-hands-on-large-language-models" style="float: left; padding-right: 20px"><img border="0" alt="Hands-On Large Language Models: Language Understanding and Generation" src="https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1718922029l/210408850._SX98_.jpg" /></a><a href="https://www.goodreads.com/book/show/210408850-hands-on-large-language-models">Hands-On Large Language Models: Language Understanding and Generation</a> by <a href="https://www.goodreads.com/author/show/49140473.Jay_Alammar">Jay Alammar</a><br/>
My rating: <a href="https://www.goodreads.com/review/show/7563994596">4 of 5 stars</a><br /><br />
This book made me more curious about LLM and made me think of it as something complicated in some way, but with some study of the basics and an understanding of the logic, it’s possible to quickly get into this topic. It also made me realize how powerful and useful current LLM tools are for solving business problems.<br />I picked up this book because I wanted to have a better understanding of large Language models due to their current importance in new technologies and their relevance in solving business problems. <br />I liked how the author clearly explained how LLMs work and their structure. I also liked the useful tools that the authors mentioned, such as libraries and frameworks for solving problems, fine-tuning, rag, etc. I think these tools will help me a lot to structure solutions to problems.<br />The only "bad part" of the book is that I struggled with the final section about fine-tuning. I think this topic is relevant and could have been introduced better to improve understanding of the different fine-tuning approaches mentioned by the authors.<br />If you want to understand how LLMs such as ChatGPT, Claude or Gemini work, or if you have unstructured business data that you want to structure it and think LLMs could be a solution to this problem, this book is a good place to start to understand the basics and determine if it could be an approach to business problems.
<br/><br/>
<a href="https://www.goodreads.com/review/list/112709167-david-mart-nez">View all my reviews</a>
`
    },
    {
        goodreadsHtml: `<a href="https://www.goodreads.com/book/show/47668.Ensayo_sobre_la_ceguera" style="float: left; padding-right: 20px"><img border="0" alt="Ensayo sobre la ceguera" src="https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1307808756l/47668._SX98_.jpg" /></a><a href="https://www.goodreads.com/book/show/47668.Ensayo_sobre_la_ceguera">Ensayo sobre la ceguera</a> by <a href="https://www.goodreads.com/author/show/1285555.Jos_Saramago">José Saramago</a><br/>
My rating: <a href="https://www.goodreads.com/review/show/3852484680">5 of 5 stars</a><br /><br />
Execelente libro, entretenido. Con muchas frases increíbles en su relato. Me generó un poco de miedo o ansiedad al final, pero muy interesante.
<br/><br/>
<a href="https://www.goodreads.com/review/list/112709167-david-mart-nez">View all my reviews</a>
`
    },
